...
fklogsensor int,
constraint fklogsensor foreign key (fklogsensor)references logsensor(idLog)
);
-- ------------------------------------------
...
INSERT INTO producao(dataColheita, haPlantados, quilosColhidos, fkUsuario, fklogsensor)  VALUES
('2025-06-01', 5000 ,125000000,1,1 ),
('2025-08-10', 2000, 44000000,2,2),
('2024-01-01', 6000,156000000,3,3);
